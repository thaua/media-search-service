...
app.get('/provider', (req, res) => listProviderExpressController.handle(req, res));
app.get('/provider/:provider/search', (req, res) => searchMediaExpressController.handle(req, res));
